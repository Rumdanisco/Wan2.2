...
def _parse_args():
    parser = argparse.ArgumentParser(description="Wan2.2 multi-mode generation (T2V, I2V, S2V)")
...
def generate(args):
    ...
    if args.task.startswith("t2v"):
        ...
        video = pipeline.generate(
            ...
            pose_video=None,
            max_area=MAX_AREA_CONFIGS[args.size],
            infer_frames=(args.frame_num or cfg.frame_num),
            shift=(args.sample_shift or cfg.sample_shift),
            sample_solver="unipc",
            sampling_steps=(args.sample_steps or cfg.sample_steps),
            guide_scale=(args.sample_guide_scale or cfg.sample_guide_scale),
